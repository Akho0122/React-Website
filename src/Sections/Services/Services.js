...
const Services = (props) => {
    ...
    useEffect(()=> {
        ...
        const mg = window.matchMedia("(max-width: 40em)");
    ...
    <Background ref={ref}>
        ...
        <Content ref={addToRef}>
            ...
            subText={"We help clients to build great " +
        ...
        <Content ref={addToRef}>
            <TextBlock
                ...
                subText={"We build appropriate solution to develop" +
                "your website & app with best tools available"}
            />
            <DBJ>
